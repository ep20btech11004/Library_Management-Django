# Generated by Django 4.2.1 on 2023-07-21 10:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='book',
            constraint=models.CheckConstraint(check=models.Q(('rel_date__lte', datetime.date(2023, 7, 21))), name='Release Date', violation_error_message='Invalid Release Date'),
        ),
        migrations.AddField(
            model_name='login',
            name='groups',
